#decompiled by Mr.NexT
import os, sys
print '\x1b[1;33mSudah punya ID dan Password nya?'
print '\x1b[1;32mSilahkan Login  akun lo ya babang tanvam'
import os, sys

def wa():
    os.system('xdg-open https://api.whatsapp.com/send?phone=6285536324036&text=Abang ganteng, apa user & passnya?')
...
if sandi == 'Kontol' and user == 'Memek':
    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.youtube.com/channel/UCaKLg1ELiX0zTJ6Je3c5esA    /')
                time.sleep(2)
                menu()
...
def menu():
    ...
    print '\x1b[1;37;40m2. Hack Akun Facebook By mr next'
